        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h4>Edit Kontraktor Proyek</h4>
                    <h6>Mengubah data kontraktor proyek</h6>
                </div>
            </div>

            <div class="card">
                <div class="card-body">
                    <form action="{{ route('kontraktor.update', $dataKontraktor->kontraktor_id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                                    ...
                                    <select class="form-select" id="proyek_id" name="proyek_id" required>
                                        ...
                                        @foreach($dataProyek as $proyek)
                                            <option value="{{ $proyek->proyek_id }}"
                                                {{ $dataKontraktor->proyek_id == $proyek->proyek_id ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama"
                                        placeholder="Masukkan nama kontraktor" required
                                        value="{{ old('nama', $dataKontraktor->nama) }}">
                                    @error('nama')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="penanggung_jawab" name="penanggung_jawab"
                                        ...
                                        value="{{ old('penanggung_jawab', $dataKontraktor->penanggung_jawab) }}">
                            ...
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kontak" name="kontak"
                                        ...
                                        value="{{ old('kontak', $dataKontraktor->kontak) }}">
                                    @error('kontak')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="alamat" name="alamat" rows="3"
                                        placeholder="Masukkan alamat kontraktor">{{ old('alamat', $dataKontraktor->alamat) }}</textarea>
                                    @error('alamat')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
