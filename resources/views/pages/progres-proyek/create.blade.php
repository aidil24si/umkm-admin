        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h4>Tambah Progres Proyek</h4>
                    <h6>Membuat data progres proyek</h6>
                </div>
            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="tahap_id" name="tahap_id" required>
                                        ...
                                        @foreach ($dataTahapan as $tahap)
                                            <option value="{{ $tahap->tahap_id }}" {{ old('tahap_id') == $tahap->tahap_id ? 'selected' : '' }}>
                                                {{ $tahap->nama_tahap }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="catatan" name="catatan" rows="4"
                                              placeholder="Masukkan catatan progres">{{ old('catatan') }}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <button type="submit" class="btn btn-submit me-2">
                                    <i class="fe fe-save me-1"></i> Tambah Data
                                </button>
